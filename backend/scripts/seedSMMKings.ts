...
const SERVICES: ServiceDef[] = [
  ...
  // Followers
  {
    ...
    category: "followers",
    description:
      "Seguidores de entrega instantánea. ⚠️ Precio bajo = sin reposición. Si se caen, no hay reembolso. Ideal para pruebas o cuentas nuevas.",
  ...
  },
  {
    ...
    category: "followers",
    description:
      "Seguidores reales de alta calidad. ⚠️ Sin reposición automática. Si se caen, no hay reembolso. Para garantía, usá el servicio Premium 365d.",
    deliverySpeed: "Instantáneo",
  ...
  },
  {
    ...
    category: "followers",
    description:
      "✅ Seguidores HQ con reposición automática 365 días. Si se caen, se reponen solos por un año. Recomendado.",
    deliverySpeed: "Instantáneo",
  ...
  },
  {
    ...
    category: "followers",
    description:
      "✅ Seguidores HQ hasta 1 millón con reposición automática 30 días.  Ideal para cuentas que necesitan volumen con garantía.",
    deliverySpeed: "Instantáneo",
  ...
  // Likes
  {
    ...
    category: "likes",
    description:
      "Likes instantáneos para FOTOS y REELS. ✅ Usar con: instagram.com/p/ (fotos) o instagram.com/reel/ (videos). ❌ NO usar con enlaces de perfil.",
    deliverySpeed: "Instantáneo",
  ...
  },
  {
    ...
    category: "likes",
    description:
      "Likes HQ de cuentas reales para FOTOS y REELS. ✅ Usar con: instagram.com/p/ (fotos) o instagram.com/reel/ (videos). Reposición automática.",
  ...
  },
  {
    ...
    category: "likes",
    description:
      "Interacciones reales en stickers de Historias (links, encuestas, preguntas). Ideal para campañas que buscan engagement además de vistas.",
  ...
  // Views
  {
    ...
    category: "views",
    description:
      "Vistas para VIDEOS/REELS. S1 Worldwide, ideal para publicaciones que necesitan velocidad extra. ⚠️ SOLO funciona con: instagram.com/reel/ (videos) o instagram.com/tv/. ❌ NO funciona con fotos instagram.com/p/",
  ...
  },
  {
    ...
    category: "views",
    description:
      "Vistas reales para tus Historias más recientes. Distribuye la entrega en las últimas 5 historias activas.",
  ...
  },
  {
    ...
    category: "views",
    description:
      "Cobertura HQ para todas tus historias activas. Ideal para cuentas con alto volumen que quieren evitar drops.",
  ...
  },
  {
    ...
    category: "views",
    description:
      "Combiná vistas y alcance en todas tus historias activas (hasta 10K). Perfecto para empujar métricas de descubrimiento.",
    deliverySpeed: "0-6 horas",
  ...
  // Likes
  {
    ...
    deliverySpeed: "Instantáneo",
    providerServiceId: 3998, // TT likes HQ Max 100K [30 Days Refill] $0.143/1000
    sortOrder: 40,
  },
  {
    ...
    deliverySpeed: "Instantáneo",
    providerServiceId: 4003, // TT likes HQ Max 60K [365 Days Refill] $0.50/1000
    sortOrder: 41,
  },
  ...
  // Views
  {
    ...
    deliverySpeed: "Instantáneo",
    providerServiceId: 6809, // TT views S11 [30 Days Refill] $0.08/1000
    sortOrder: 50,
  },
  {
    ...
    deliverySpeed: "Instantáneo",
    providerServiceId: 3893, // TT views S9 [365 Days Guarantee] [STABLE] $0.12/1000
    sortOrder: 51,
  },
...
async function main() {
  ...
  const provRow = await db.query(
    `SELECT id FROM providers WHERE name = $1 AND is_active = true`,
    [PROVIDER_NAME],
  );
  if (!provRow.rows.length) {
    console.error("❌ Proveedor SMMKings no encontrado en DB.");
    process.exit(1);
  }
  ...
  for (const def of SERVICES) {
    ...
    if (!prov) {
      console.warn(
        `⚠️  ID ${def.providerServiceId} no encontrado en SMMKings: ${def.name}`,
      );
      skipped++;
      continue;
    }
    ...
    const existing = await db.query(`SELECT id FROM services WHERE name = $1`, [
      def.name,
    ]);
    ...
    if (existing.rows.length) {
      ...
      console.log(
        `🔄 ${def.name} → $${costUSD}/1000 USD → $${pricePerUnit} ARS/u | min:${minQty} max:${maxQty}`,
      );
      updated++;
    } else {
      await db.query(
  ...
  console.log("\n" + "─".repeat(60));
  console.log(
    `📊 RESUMEN: ${created} creados | ${updated} actualizados | ${skipped} saltados`,
  );
  if (skipped > 0) {
    console.log(
