  ...
  return (
    <div className="min-h-screen bg-dark-300">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full bg-primary-500 shadow-lg shadow-primary-500/40 flex items-center justify-center text-white hover:bg-primary-400 transition-colors"
      >
