    ...
    <div className="min-h-screen bg-dark-300 flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-white">Bienvenido de vuelta</h1>
        ...
        <div className="glass-card p-6 sm:p-8">
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            ¿No tenés cuenta?{' '}
            <Link href="/register" className="text-primary-400 hover:text-primary-300 font-medium">Creá una gratis</Link>
          </p>
        </div>
      </motion.div>
    </div>
